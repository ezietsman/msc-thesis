...
#pl.subplots_adjust(hspace=0.001,bottom=0.35)
#ax1=pl.subplot(211)
...
pl.colorbar(im,orientation='horizontal',ticks=list(pl.arange(min(levels),max(levels),0.00075)),   shrink=1.0)
